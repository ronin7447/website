  ...
  return (
   <div>
    ...
    <div className="max-w-screen-xl sm:px-6 mt-12 mb-24 mx-auto">
      <h1 className="text-3xl sm:text-4xl font-semibold tracking-tighter px-6 sm:px-0 mb-8 md:mb-12">Our Sponsors</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 sm:px-0 px-6">
        <Link href="https://iusd.org/" rel="nofollow"><Image src={iusdImg} alt="Irvine Unified School District" className="w-full" width={500} /></Link>
        <Link href="https://portolahigh.iusd.org/" rel="nofollow"><Image src={portolaImg} alt="Portola High School" className="w-full" width={500} /></Link>
      </div>
